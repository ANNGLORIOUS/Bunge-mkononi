...
COHERE_CHAT_MODEL = _env("COHERE_CHAT_MODEL", "command-a-03-2025")
COHERE_VISION_MODEL = _env("COHERE_VISION_MODEL", "command-a-vision-07-2025")
COHERE_RERANK_MODEL = _env("COHERE_RERANK_MODEL", "rerank-v4.0-fast")
COHERE_REQUEST_TIMEOUT = int(_env("COHERE_REQUEST_TIMEOUT", "30"))
COHERE_REQUEST_MAX_RETRIES = int(_env("COHERE_REQUEST_MAX_RETRIES", "2"))
COHERE_REQUEST_RETRY_BASE_DELAY = float(_env("COHERE_REQUEST_RETRY_BASE_DELAY", "1.0"))
